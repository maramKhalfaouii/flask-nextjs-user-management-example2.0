...
/* harmony import */ var components_text_input__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("7fPw");
/* harmony import */ var services__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("GwW/");
/* harmony import */ var utils_auth__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("q+Fc");
...
const Login = () => {
  ...
  const onSubmit = async e => {
    ...
    setIsError(false);
    try {
      const api = new services__WEBPACK_IMPORTED_MODULE_2__[/* AuthApi */ "a"]();
      api.setup();
      ...
      if (response.kind === "ok") {
        ...
        Object(utils_auth__WEBPACK_IMPORTED_MODULE_3__[/* login */ "d"])(token);
      } else {
        setIsError(true);
      }
    } catch (err) {
  ...
  return __jsx("div", null, __jsx(LoginForm, {
    onSubmit: onSubmit
  }, __jsx(components_text_input__WEBPACK_IMPORTED_MODULE_1__[/* TextInput */ "a"], {
    label: "Email",
    type: "email",
    id: "email",
    name: "email",
